...
const isValidNewsId = computed(
  () => Number.isInteger(form.value.newsId) && form.value.newsId > 0
)
    ...
    <div class="bg-white rounded-2xl shadow border border-gray-100 p-5 space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <label class="block">
          ...
          <input v-model.trim="form.user" type="text" class="mt-1 w-full border rounded-lg px-3 py-2" />
        </label>
      </div>
      ...
      <div class="space-y-3">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label class="block">
            ...
            <input type="file" accept="image/*" multiple @change="onPickAttachments"
          ...
          <label class="block">
            ...
            <div class="mt-1 flex gap-2">
              ...
              <button type="button" @click="addUrlAttachment"
