...
const props = withDefaults(defineProps<{ item: NewsItem; reverse?: boolean }>(), { reverse: false })
...
<template>
  ...
  <article
    class="rounded-2xl bg-white ring-1 ring-black/5 shadow-sm overflow-hidden grid md:grid-cols-2 transition hover:-translate-y-0.5 hover:shadow-md md:h-500px]"
  >
    <div
